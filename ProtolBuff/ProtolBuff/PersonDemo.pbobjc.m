...
#pragma mark - PersonDemoRoot

@implementation PersonDemoRoot
...
#pragma mark - PersonDemoRoot_FileDescriptor

static GPBFileDescriptor *PersonDemoRoot_FileDescriptor(void) {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[Person class]
                                     rootClass:[PersonDemoRoot class]
                                          file:PersonDemoRoot_FileDescriptor()
                                        fields:fields
